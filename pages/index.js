...
export default function Index({ config, kvMonitors, kvMonitorsLastUpdate }) {
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>{config.settings.title} Status</title>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-row justify-between items-center p-4">
          <div className="flex flex-row items-center">
            <img className="h-8 w-auto logo-img" src={config.settings.logo} />
            <h1 className="ml-4 text-3xl hidden sm:block">{config.settings.title}</h1>
          </div>
          <div className="flex flex-row items-center">
